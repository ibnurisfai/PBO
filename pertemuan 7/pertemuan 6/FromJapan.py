...
from tkinter import END, Label, Text, Scrollbar, Button, RIGHT, Y

class TranslatorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Indonesian to Japanese Translator")
        self.setup_gui()
    ...
    def setup_gui(self):
        ...
        self.label_output = Label(self.root, text="Output Text (Japanese):")
    ...
    def translate_text(self):
        ...
        translation = translator.translate(input_text, src='id', dest='ja')
